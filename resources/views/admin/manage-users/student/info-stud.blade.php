...
@if (!empty($user))
	<div class="row pb-2">
		<div class="col-md-10 section-title">Student Information</div>
	...
	<div class="form-group row mb-2">
		...
		<div class="col-md-9 col-form-label">{{ $user->stud_nomat }}</div>
	</div>

	<div class="form-group row mb-2">
		<div class="col-md-3 col-form-label font-weight-bold">No. MyKad</div>
		<div class="col-md-9 col-form-label">{{ \App\Var\GlobalFunction::format_nokp($user->stud_nokp) }}</div>
	</div>
