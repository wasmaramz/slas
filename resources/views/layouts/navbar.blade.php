...
<nav class="navbar navbar-expand-lg main-navbar">
	...
	<ul class="navbar-nav navbar-right">
		<!-- Messages Box -->
		{{-- check original navbar --}}

		<!-- Notifications -->
		{{-- YANG INI GANTI DENGAN YANG BAWAH --}}
		<li class="dropdown dropdown-list-toggle">
			<a href="javascript:void(0)" class="nav-link notification-toggle nav-link-lg beep" onclick="swal('Still in Development.')"><i class="far fa-bell"></i></a>
		</li>
				...
				<div class="dropdown-menu dropdown-list dropdown-menu-right">
					<div class="dropdown-header">Notifications
						<div class="float-right">
							<a href="javascript:void(0)" onclick="swal('Still in Development.')">Mark All As Read</a>
						</div>
					</div>
					<div class="dropdown-list-content dropdown-list-icons">
						<a href="javascript:void(0)" class="dropdown-item dropdown-item-unread" onclick="swal('Still in Development.')">
						...
						<a href="javascript:void(0)" class="dropdown-item" onclick="swal('Still in Development.')">
					...
					<div class="dropdown-footer text-center">
						<a href="javascript:void(0)" onclick="swal('Still in Development.')">View All <i class="fas fa-chevron-right"></i></a>
					</div>
				</div>
			</li>
		--}}
		...
		<li class="dropdown">
			<a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
				...
				<div class="d-sm-none d-lg-inline-block"><span id="badge-sp_usr_fname">{{ session('sess_user_fullname') }}</span></div>
			</a>
